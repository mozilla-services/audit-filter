...
module.exports.run_wasm = function(audit_str, nsp_config_str, output_json) {
    var ptr0 = passStringToWasm0(audit_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(nsp_config_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    var ret = wasm.run_wasm(ptr0, len0, ptr1, len1, output_json);
    return ret;
};
...
const path = require('path').join(__dirname, 'audit_exclude_bg.wasm');
